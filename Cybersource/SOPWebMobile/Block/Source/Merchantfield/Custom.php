...
class Cybersource_SOPWebMobile_Block_Source_Merchantfield_Custom extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    /**
     * Main constructor
     */
    public function __construct()
    {
        ...
        $this->addColumn('value', array(
            ...
            'style' => 'width:100px',
            'type'  => 'select',
            'options' => Mage::getModel('cybersourcesop/source_merchantfields')->toOptionArray(),
        ));
        ...
        $this->setTemplate('cybersourcesop/array.phtml');
    }
    ...
    protected function _renderCellTemplate($columnName)
    {
        ...
        if($columnName === 'value'){
            ...
            foreach (Mage::getModel('cybersourcesop/source_merchantfields')->toOptionArray() as $option) {

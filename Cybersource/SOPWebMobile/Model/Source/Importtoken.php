...
class Cybersource_SOPWebMobile_Model_Source_Importtoken extends Mage_Core_Model_Config_Data {
    ...
    {
        Mage::getResourceModel('cybersourcesop/token')->uploadAndImport($this);
    }
}

...
class Cybersource_SOPWebMobile_Model_Source_Merchantfield_Array extends Mage_Adminhtml_Model_System_Config_Backend_Serialized_Array
{
    /**
     * System config key for merchant-fields
     * @access protected
     * @var string
     */
    protected $_eventPrefix = 'cybersourcesop_config_backend_merchantfields';
}

...
class Cybersource_SOPWebMobile_Model_Source_Cardchecks
{
    /**
	...
	public function toOptionArray()
	{
		return array(
				array(
						'value' => Cybersource_SOPWebMobile_Model_Source_Consts::CONFIG_CARDCHECK_ACCEPT,
						'label' => Mage::helper('core')->__('Accept')
				),
				array(
						'value' => Cybersource_SOPWebMobile_Model_Source_Consts::CONFIG_CARDCHECK_ACCEPT_HOLD,
						'label' => Mage::helper('core')->__('Accept and Hold')
				),
				array(
						'value' => Cybersource_SOPWebMobile_Model_Source_Consts::CONFIG_CARDCHECK_DECLINE,
